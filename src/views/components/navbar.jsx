    ...
    return (
        ...
        <div className="flex items-center h-[70px]">
            ...
            <div className="flex items-center gap-4 md:gap-0">
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <a href="/course" className="text-slate-900 block pt-4 px-4">
                            Course
                        </a>
            ...
            <div className="flex items-center gap-4 ml-auto">
                ...
                <a
                    href="/register"
                    className="hidden md:inline rounded bg-blue-500 hover:bg-blue-600 border border-blue-500 hover:border-blue-600 py-2 px-4 font-semibold text-white text-center transition duration-300 ease-in-out"
                >
                    Sign Up
                </a>
                </nav>
