...
const Sidebar = () => {
    ...
    const menuItems = [
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5 mr-3">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 20h5v-2a4 4 0 00-3-3.87M9 20v-6a4 4 0 015-3.87M9 10V6a4 4 0 114 4v4m0 10h-5v-6m5-4h5" />
                </svg>
            ),
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5 mr-3">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h11M9 21v-6m0 6h3M6 9l6-6m2 6H3m8 6v6m0-6h6" />
                </svg>
            ),
        },
        {
            ...
            roles: ['owner', 'teacher'],
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5 mr-3" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        },
        {
            ...
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="h-5 w-5 mr-3">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 7h4V3h4v4h4v4h4V3h4v4h4M3 7h4V3h4v4h4v4h4V3" />
                </svg>
            ),
        },
        {
        ...
        },
        {
            ...
            roles: ['owner', 'teacher'],
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"></circle>
                                    ...
                                    <li key={item.name}>
                                        <NavLink
                                            ...
                                            className={({ isActive }) =>
                                                ...
                                                isActive ? 'text-blue-700 relative' : 'text-slate-900'
                                                }`
                                            }
                                            >
                                            {({ isActive }) => (
                                    ...
                                    item.roles.includes(userRole) && (
                                        <div key={item.name}>
                                            <NavLink
                                                to={item.path}
                                                className={({ isActive }) =>
                                                    `flex items-center ${isActive ? 'text-blue-500' : 'text-slate-900'}`
                                                }
                                            >
                                                {item.icon}
                                                <span>{item.name}</span>
