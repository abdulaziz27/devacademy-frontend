...
const Settings = () => {
    ...
    const [successMessage, setSuccessMessage] = useState(status === 'password-updated');
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white sm:p-8 rounded-lg shadow">
                            ...
                            <section className="space-y-6">
                                    ...
                                    <button type="submit" className="py-2 px-4 bg-red-500 text-white rounded hover:bg-red-600 focus:outline-none transition duration-300"
                                    ...
                                    {isModalVisible && (
                                        <div id="confirm-user-deletion-modal" className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50">
                                            <div className="bg-white p-6 rounded-lg shadow-lg">
                                                <form method="post" action="/dummy-delete-account" className="p-6">
                                                    <h2 className="text-lg font-medium text-gray-900">
