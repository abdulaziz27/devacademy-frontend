    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                const categorizedCourses = { all: courses, premium: courses.filter(course => course.is_premium) };
                ...
                setCategories([{ id: 'all', name: 'All' }, { id: 'premium', name: 'Premium' }, ...categories]);
                    ...
                    >
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {coursesByCategory[category.id] && coursesByCategory[category.id].map(course => (
                                ...
                                >
                                    <img
                                        src={course.thumbnail || '/path/to/default-thumbnail.jpg'}
                                        alt={course.title}
                                    ...
                                    <div className="flex flex-col flex-grow">
                                        <h1 className="font-semibold text-xl text-black mb-2">{course.title}</h1>
